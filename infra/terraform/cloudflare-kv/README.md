...
| `orgName` | string | `altocumulus` | Org identifier |
| `owner` | string | `altocumulus` | GitHub owner |
| `repo` | string | `altocumulus` | GitHub repo |
| `namespace` | string | `altocumulus` | Logical namespace |
