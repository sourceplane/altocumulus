 ...
 * signature verifier for Altocumulus outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Altocumulus webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Altocumulus webhook delivery.
 *
