...
// `@saas/sdk` client class name (`Altocumulus`) is intentionally NOT part of
...
export const CLI_BIN = "altocumulus";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Altocumulus";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.altocumulus.dev";
