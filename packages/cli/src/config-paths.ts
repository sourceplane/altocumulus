...
//   - `~/.config/altocumulus/credentials.json` (0600)
//   - `~/.config/altocumulus/config.json`     (0644)
//
// Override via `ALTOCUMULUS_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/altocumulus` everywhere
