// `altocumulus webhook verify` — local cryptographic verification of a
// Altocumulus outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `altocumulus login`.
