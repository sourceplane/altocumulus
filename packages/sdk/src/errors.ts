// Typed error hierarchy for the Altocumulus SDK.
//
...
// codes (forward compatibility) fall back to the generic `AltocumulusError`
...
export interface AltocumulusErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof AltocumulusError`
 * still matches.
 */
export class AltocumulusError extends Error {
  ...
  constructor(init: AltocumulusErrorInit) {
    super(init.envelope.message);
    this.name = "AltocumulusError";
...
export class BadRequestError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class UnauthenticatedError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class ForbiddenError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class NotFoundError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class ConflictError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class ValidationError extends AltocumulusError {
...
export class PreconditionFailedError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class UnsupportedError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export class InternalError extends AltocumulusError {
  constructor(init: AltocumulusErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends AltocumulusErrorInit {
...
export class RateLimitError extends AltocumulusError {
...
/**
 * Decode an HTTP `Response` into the appropriate `AltocumulusError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `AltocumulusError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new AltocumulusError(init);
  }
}

function decodeRateLimit(
  init: AltocumulusErrorInit,
  response: Response,
): RateLimitError {
