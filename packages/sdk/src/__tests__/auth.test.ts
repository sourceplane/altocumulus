...
//   - AltocumulusError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Altocumulus {
  return new Altocumulus({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Altocumulus class", () => {
